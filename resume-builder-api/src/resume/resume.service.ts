...
const ATS_TEMPLATE_EXPORT_CSS = `
      ...
      * { box-sizing: border-box; }
      ...
      /* Pagination doctrine (same as .ats-section / sidebar-bold above):
         blocks and items break freely; only heading rows glue to what
         follows. break-inside: avoid-page here shoved a whole taller-than-
         a-page Work History to page 2, leaving page 1 blank after the
         summary (reported against every nb-visual template). */
      .nb-visual__block { margin-bottom: 14px; break-inside: auto; page-break-inside: auto; }
      ...
      .nb-visual__item { margin-bottom: 10px; break-inside: auto; page-break-inside: auto; }
      .nb-visual__item-head { display: flex; justify-content: space-between; gap: 10px; align-items: baseline; break-after: avoid; page-break-after: avoid; }
      ...
      .nb-visual__bullets { margin: 0; padding-left: 16px; orphans: 3; widows: 2; }
