...
function enhanceExperienceExtraction(input) {
    ...
    if (input.parsed) {
        ...
        const hasExperienceSection = sectionKeys.some((k) => ['experience', 'employment', 'work', 'career'].includes(k));
        const hasOtherSections = sectionKeys.some((k) => ['education', 'skills', 'projects', 'certifications', 'summary'].includes(k));
