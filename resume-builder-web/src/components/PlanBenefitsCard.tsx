...
const BENEFITS: Record<Plan, Benefit[]> = {
  FREE: [
    ...
    { label: 'Unlimited PDF & Word exports', details: '₹49 per export — pay only for the resumes you download, no monthly cap.' },
...
function PLUS_BENEFITS(): Benefit[] {
  return [
    { label: '300 ATS scans / month', details: 'Effectively unlimited for a job hunt.' },
    { label: 'Our AI across every feature', details: 'No need to bring your own key — AI critique, JD match, Mentor Mode, Mentor Chat, and more all run on our AI.' },
    { label: 'No per-download AI fee', details: 'Plus waives the AI charge on downloads. (The ₹49 export fee still applies.)' },
