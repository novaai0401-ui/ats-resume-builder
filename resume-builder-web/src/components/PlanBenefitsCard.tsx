...
const BENEFITS: Record<Plan, Benefit[]> = {
  ...
  STUDENT: [
    ...
    { label: 'Unlimited PDF & Word exports', details: 'Included with your plan — no per-download charge, no monthly cap.' },
  ...
  PRO: [
    ...
    { label: 'Unlimited PDF & Word exports', details: 'Included with your plan — run as many portfolio variants as you like.' },
