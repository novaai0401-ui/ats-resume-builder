    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          {onLogout && (
            <TouchableOpacity onPress={onLogout} style={{ paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: '#c4d5e0' }}>
              <Text style={{ color: '#1a3a5c', fontSize: 13, fontWeight: '500' }}>Logout</Text>
            </TouchableOpacity>
          )}
        </View>
